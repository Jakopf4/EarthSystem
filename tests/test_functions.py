...
def test_in_degrees():
    ...
    from scripts.inout import in_degrees
...
def test_out_degrees():
    ...
    from scripts.inout import out_degrees
...
def test_neighbourhood():
    ...
    from scripts.clustering import find_neighbourhood
...
def test_clustering():
    ...
    from scripts.clustering import clustering_coefficients
...
def test_ffl():
    ...
    from scripts.clustering import feed_forward_loop
