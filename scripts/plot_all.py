...
def plot_yearly_degrees(scenario: str, year: int) -> None:
    ...
    filepath = f"../data/scenario_ssp245_decade2030_month12.nc"
    ds = xr.open_dataset(filepath)
    ...
    # plt.show()
    plt.savefig(
        f"../results/plots/InOut/Scenario{scenario}/yearly_degrees_{scenario}_{year}.png"
    )
    plt.close(fig)
