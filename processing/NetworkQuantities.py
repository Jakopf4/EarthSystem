...
def calculate_network_metrics(scenario: int, year: int, month: int, thresholds: list,
    ...
    if def_option == "Raw":
        ...
        nc_filepath = f"../pre-processing/pre-processed-data/water_BaU/scenario_ssp{scenario}_decade{year}_month{month:02d}_BaU.nc"
    elif def_option == "Gov":
        nc_filepath = f"../pre-processing/pre-processed-data/water_Gov/scenario_ssp{scenario}_decade{year}_month{month:02d}_Gov.nc"
    elif def_option == "Sec":
        nc_filepath = f"../pre-processing/pre-processed-data/water_Sec/scenario_ssp{scenario}_decade{year}_month{month:02d}_Sec.nc"
...
def calculate_yearly_network_metrics2(scenario: int, year: int, thresholds: list, def_option: str = "Raw"):
    ...
    if def_option == "Raw":
        nc_filepath = f"../pre-processing/pre-processed-data/water_Raw/scenario_ssp{scenario}_decade{year}_Raw.nc"
    elif def_option == "BaU":
        nc_filepath = f"../pre-processing/pre-processed-data/water_BaU/scenario_ssp{scenario}_decade{year}_BaU.nc"
    elif def_option == "Gov":
        nc_filepath = f"../pre-processing/pre-processed-data/water_Gov/scenario_ssp{scenario}_decade{year}_Gov.nc"
    elif def_option == "Sec":
        nc_filepath = f"../pre-processing/pre-processed-data/water_Sec/scenario_ssp{scenario}_decade{year}_Sec.nc"
...
def execute_yearly_network_metrics():
    ...
    years_raw = range(2030, 2100)
    years_def = range(2030, 2051)
    thresholds = [12*1.0, 12*1.14, 12*1.5]
